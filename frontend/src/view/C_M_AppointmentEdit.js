...
export default function C_M_AppointmentEdit(props) {
    ...
    const [appointmentDate, setAppointmentDate] = useState(appointmentData.appointmentDate);
                                ...
                                <div class="card-body" >
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <FormInputDate value={appointmentData.appointmentDate} title="number" onSave={appointmentSetHandler} />
                                        </div>
                                    ...
                                    <button type="submit" onClick={() => editMyAppointment(id)} class="btn  btn-primary" id="addCustomer" style={{ backgroundColor: '#081E3D', borderColor: '#081E3D', color: '#fff' }}  >Submit</button>

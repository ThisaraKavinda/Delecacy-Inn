                                ...
                                <div class="card-body" >
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <FormInput value={customerData.name} title="number" onSave={nameSetHandler} />
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label for="inputPassword4">Email</label>
                                            <FormInput value={customerData.email} title="number" onSave={emailSetHandler} />
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 ">
                                        ...
                                        <FormInput value={customerData.address} title="number" onSave={addressSetHandler} />
                                    </div>

                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            <label for="inputCity">NIC</label>
                                            <FormInput value={customerData.nic} title="number" onSave={nicSetHandler} />
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label for="inputCity">Contact No</label>
                                            <FormInput value={customerData.contactNo} title="number" onSave={phoneSetHandler} />
                                        </div>

                                    </div>
                                   

                                   <button type="submit" onClick={() => editMyCustomer(id)} class="btn  btn-primary" id="addCustomer" style={{ backgroundColor: '#081E3D', borderColor: '#081E3D', color: '#fff' }} >Submit</button>
